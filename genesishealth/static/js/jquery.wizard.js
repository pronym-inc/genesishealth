    ...
    $.wizard = function(el, options){
        ...
        base.init = function(){
            ...
            $(".items > section", base.$el).each(function(){
                $('input, select', this).validator({
                    messageClass: 'wizard-error',
                    onSuccess: base.options.validatorOnSuccess,
                    onFail: base.options.validatorOnFail,
                    errorInputEvent: base.options.validatorErrorInputEvent
                });
            });
            ...
            $("button.next", base.$el).keydown(function(e) {
                if (e.keyCode == 9) {
                    ...
                    $('section.current').find('.next').click();
										// api.next(); 
                }
            });
